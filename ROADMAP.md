...
Pipeline complet en 38 étapes (orchestrateur `etl/pipeline.py`), factorisé en helpers :
...
- [x] Localisations sauvages - `load_pokedex_locations.py` parse la page Pokédex du wiki IF (541/572 Pokémon couverts, 2 448 entrées `pokemon_location`)
